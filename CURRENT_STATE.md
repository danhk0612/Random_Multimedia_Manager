...
| 랜덤 후보·Pending 방문 핵심 | T06 구현·Windows 자동 검증 완료, PR #13 main 통합 완료; T11 완료, 기본 동작 사용자 확인·어려운 수동 검사 생략, PR #14 병합 대기 |
...
| 만화/영상 이어보기 DB 연결 | T11 완료 — 기본 동작 사용자 확인, 어려운 수동 검사 생략·미검증 (PR #14 병합 대기) |
...
## T11 공통 감상 연결 — 완료, PR #14 병합 대기 (수동 생략 범위는 최종 검증 정리 참조)
