...
| 단축키·트레이·빠른 숨김/종료 | T14 정책/상태 설계 완료, 제품 코드는 미구현; T12 통합 대조 후 T15/T16 대기 |
| VSR | 후순위, 가능성 미검증 |
...
## T14 프로그램 생명주기 정책 설계 — 완료, PR 검토/통합 대기
...
- T12의 삭제 저널·AppliedDeletion·격리 계약은 변경하지 않았다. T12 병합 후 Deleting/Unknown/Succeeded+DB 정리 관찰 경계와 미디어 해제 소유권만 대조해야 하며, 그 전에는 T15/T16을 착수하지 않는다.
