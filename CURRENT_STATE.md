...
- 다음 착수: T05 라이브러리 최초/수동 스캔 — Sol. T03/T04 선행 충족. 영상 확장자 미확정 차단은 docs/DECISIONS.md의 “T05 초기 인덱싱 확장자 결정”으로 해제했다. 사용자 보고상 task/t05-library-scan 브랜치에서 제품 코드 변경 전 보류했으며 최신 main 반영 후 재개한다. 스캔은 아직 미구현이다.
