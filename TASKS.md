...
T01은 Windows 검증 대기이고 T02 문서 계약은 완료했다. 병렬 문서 설계는 허용되며 후속 코드는 아직 착수하지 않는다. D01/D02의 사용자 결정과 나머지 세부 정책 위임은 docs/DECISIONS.md에 반영되어 있다. T02는 코드/프로젝트 파일을 변경하지 않는다. T03 등 후속 코드 구현 착수 전에는 T01 완료와 T02 계약 확정을 모두 확인한다.
