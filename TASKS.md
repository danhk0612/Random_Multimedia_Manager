...
| T03 | SQLite 저장 기반 | Astra | 구현·검증 중 | T01 완료 및 T02 계약 확정 |
...
T01은 사용자 Windows 검증 확인으로 완료했고 T02 계약은 main에 통합되었다. T03 선행 조건이 충족되었으므로 최신 main에서 별도 브랜치를 만들어 T03만 재개한다. 정책과 위임 범위는 docs/DECISIONS.md를 따른다.
