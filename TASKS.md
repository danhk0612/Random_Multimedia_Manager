...
| T09 | LibVLC 영상 기반 검증 및 통합 | Astra | 구현 검증 중 (미완료) | T01/T02/T03 |
...
- 담당/상태: Astra / 구현 검증 중, 미완료 (PR #7 Draft).
- 선행: T01 완료/T02 계약 통합/T03 공유 모델.
...
- 현재 결과: 패키지 고정·영상 측 Prepare/Ready/Activate와 해제·최소 WPF 검증 UI 구현. 로컬 정적 검사 통과, Windows CI 확인 중. 실제 음성/HW/중첩/전체화면은 미검증.
